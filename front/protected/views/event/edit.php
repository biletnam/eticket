...
<!--                                                <label class="checkbox inline">
                                ...
                                <div class="controls-group clearfix upload">
                                    ...
                                    <div class="controls pull-left">
                                        <?php if ($event['img'] == ""): ?>
                                            <img class="image-default" src="<?php echo HelperUrl::baseUrl() ?>img/default_upload_logo.gif" />
                                        <?php else: ?>
                                            <img class="image-default default hide" src="<?php echo HelperUrl::baseUrl() ?>img/default_upload_logo.gif" />
