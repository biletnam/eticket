...
<div class="container_12">
    ...
    <div class="clearfix">
        <div class="grid_12 page-create-ticket">
                    ...
                    <div class="row-fluid content">
                        ...
                        <div class="span10 form-magu">
                            ...
                            <div class="controls-group clearfix">
                                <label class="control-label pull-left" for="title">Event Title<span class="required">*</span></label>
                            ...
                            <div class="controls-group clearfix">
                                <label class="control-label pull-left" for="address">Address<span class="required">*</span></label>
                            ...
                            <div class="controls-group clearfix">
                                <label class="control-label pull-left" for="address">Address 2</label>
                                <div class="controls pull-left"><input type="text" class="input-xxlarge span11" name="address_2" value="<?php echo isset($_POST['address_2']) ? htmlspecialchars($_POST['address_2']) : htmlspecialchars($event['address_2']); ?>"></div>
                            </div>
                                ...
                                <div class="controls pull-left">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="input-append date dp3" data-date-format="mm/dd/yyyy">
                                            <input type="text" class="input-mini ico ico-calendar datetimepicker" name="start_date" value="<?php
                                            if (isset($_POST['start_date']))
                                                echo $_POST['start_date'];
                                            else
                                                echo date('d-m-Y', strtotime($event['start_time']));
                                            ?>">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="input-append date dp3" data-date-format="mm/dd/yyyy">
                                            <input type="text" class="input-mini ico ico-calendar datetimepicker" name="end_date" value="<?php
                                            if (isset($_POST['end_date']))
                                                echo $_POST['end_date'];
                                            else
                                                echo date('d-m-Y', strtotime($event['end_time']));
                                            ?>">
                            ...
                            <div class="controls-group clearfix upload">
                                <label class="control-label pull-left" for="title">Event Logo:</label>
                            ...
                            <div class="controls-group clearfix">
                                <label class="control-label pull-left">Event Description <!--<label class="control-label add-faq"> <a href="">+Add FAQs</a></label>--></label>
                            ...
                            <div class="controls-group clearfix">
                                ...
                                <div class="controls pull-left"><input type="text" class="input-xxlarge span11" name="facebook" value="<?php echo (isset($_POST['facebook'])) ? htmlspecialchars($_POST['facebook']) : $event['facebook']; ?>"></div>
                            </div>

                            <div class="controls-group clearfix">
                                <label class="control-label pull-left">Event URL</label>
                                <div class="controls pull-left"><input type="text" class="input-xxlarge span11" name="link" value="<?php echo (isset($_POST['link'])) ? htmlspecialchars($_POST['link']) : $event['link']; ?>"></div>
                            </div>
                            ...
                            <div class="controls-group clearfix">
                                ...
                                <div class="controls pull-left clearfix">
                                    <input type="submit" value="Save Event" class="btn pull-right">
                                </div>
                            </div>
            ...
            <?php if ($type == "ticket"): ?>
                <input type="hidden" id="edit_ticket_form" value="1">
