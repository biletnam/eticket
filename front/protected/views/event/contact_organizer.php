<article class="container">
    ...
    <div class="row-fluid">
        <section class="span8 main">
            <article class="event contact radius-body">
                <form class="form-horizontal">
                    <div class="heading">Contact the Host</div>
                    <div class="event-body">
                        ...
                        <div class="control-group">
                            <label class="control-label">Enter the code as shown below:</label>
                            <div class="controls">
                                Captcha
                            </div>
                        </div> 
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div style="font-size: 10px">
                                    ...
                                    Your email will only be seen by the event organizer. We do not share your contact information with anyone, ever.<br><br>
                                    <div><a target="_blank" href="/tos#privacy">Find out more about how your privacy is protected.</a></div>
                                </div>
                            </div>
                        </div>  
                    </div>
