                ...
                <div class="controls">
                    <select name="city">
                        <?php foreach ($cities as $k => $v): ?>
                            <option <?php echo (isset($_POST['city']) && $_POST['city'] == $v['id']) ?  'selected' : ((isset($location['city_id']) && $location['city_id'] == $v['id']) ? 'selected' :''); ?> value="<?php echo $v['id']; ?>"><?php echo $v['title']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
