<article class="container register-event order_confirmation">
    <div class="event-header">
        <div class="alert alert-success">

            You're going! Your order is complete.
            An email confirmation has been sent to thanhtung228@gmail.com.
        ...
        <section class="span8 main">
            ...
            <article class="event ticket-info radius-body">
                <div class="event-body">
                    ...
                    <p>Let your family, friends, and followers know about this great event!</p>
                    <div class="social">Social network</div>
                </div>
            </article>
            
            <div class="alert clearfix">
                <div class="comming_up_event"><a href="#" class="btn">Your Upcoming Events</a> </div>
                <p class="alertbox">Manage your order, find events your friends are attending, and more!</p>
            </div>
            ...
            <article class="event ticket-info radius-body">
                <form>
                    ...
                    <div class="ticket panel_body">
                        <table width="100%" class="ticket_table" id="ticket_table">
                            <thead>
                                <tr class="ticket_table_head">
                                    ...
                                    <th width="30%" align="center" class="center">Quantity</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="ticket_row">
                ...
                <div id="ordermessage">
                    <p>Your registration has been successful. We will contact by email for further information shortly.</p>
